...
private slots:
    ...
    void _sendGCSRcOverrideKeepalive(); // Added for keepalive patch
...
private:
    ...
    QTimer *_gcsRcKeepaliveTimer = nullptr;         ///< Added: Timer for keepalive logic
    ...
    bool _rcKeepaliveFlip = false;                  ///< Added: State for keepalive toggle
