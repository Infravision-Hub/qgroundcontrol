...
void MissionControllerTreeTest::_testTreeStructureAfterInit()
{
    ...
    QCOMPARE(tree->data(missionGroup, Qt::UserRole + 2).toString(), QStringLiteral("missionGroup"));
    QCOMPARE(tree->data(fenceGroup, Qt::UserRole + 2).toString(), QStringLiteral("fenceGroup"));
    QCOMPARE(tree->data(rallyGroup, Qt::UserRole + 2).toString(), QStringLiteral("rallyGroup"));
    ...
    QCOMPARE(tree->data(fenceChild, Qt::UserRole + 2).toString(), QStringLiteral("fenceEditor"));
    ...
    QCOMPARE(tree->data(rallyChild, Qt::UserRole + 2).toString(), QStringLiteral("rallyHeader"));
}
